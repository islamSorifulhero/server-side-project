...
// const serviceAccount = require("./assignment-afa02-firebase-adminsdk-fbsvc-ab6f17b488.json");
admin.initializeApp({
...
async function run() {
    try {
        ...
        app.patch('/payment-success', async (req, res) => {
            ...
            const transactionId = session.payment_intent;  // const trackingId = generateTrackingId()
            ...
            if (session.payment_status === 'paid') {
                ...
                const update = {
                    $set: {
                        paymentStatus: 'paid',
                        deliveryStatus: 'pending-pickup'  // trackingId: trackingId
                    }
                }
